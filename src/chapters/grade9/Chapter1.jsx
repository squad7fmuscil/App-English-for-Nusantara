      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            <div className="inline-block bg-blue-500 text-white px-6 py-2 rounded-full mb-4">
              <span className="font-bold">KELAS 9</span>
            </div>
            <h1 className="text-4xl font-bold text-gray-800 mb-2">Chapter 1</h1>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-600">
                  Chapter ini akan berisi materi tentang kindness, helping
                  others, dan expressing gratitude.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-indigo-50 p-6 rounded-lg">
              ...
              <ul className="space-y-2 text-gray-700">
                <li>• Unit 1: Being Kind</li>
                <li>• Unit 2: Helping People</li>
                <li>• Unit 3: Say Thank You</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-100 to-indigo-100 h-64 rounded-xl flex items-center justify-center">
            <div className="text-center">
              <BookOpen size={80} className="text-blue-400 mx-auto mb-4" />
